...
- Be able to click on the column header to sort it by that column

Bonus:

- Incorporate memoization into collecting the API endpoint to increase the performance
- Add animation for transition when table is sorted
- Input bar that searches columns and highlights matches (desktop/mobile)
